    ...
    <div className={styles.filter_section}>
      ...
      {/* </div> */}
        ...
        <ul ref={menuRef} className={styles.product}>
            ...
            <li>
                <input type='checkbox' className={styles.product_checkbox} />Women 
            </li>
            <li>
                <input type='checkbox' className={styles.product_checkbox} />Kids
            </li>
            <li>
                <input type='checkbox' className={styles.product_checkbox} />Bags
            </li>
            <li>
                <input type='checkbox' className={styles.product_checkbox} />Shoes
            </li>
            <li>
                <input type='checkbox' className={styles.product_checkbox} />Wallets
            </li>
            <li>
                <input type='checkbox' className={styles.product_checkbox} />Watches
            </li>
            <li>
                <input type='checkbox' className={styles.product_checkbox} />Accessories
            </li>
            <li>
                <input type='checkbox' className={styles.product_checkbox} />Sunglasses
            </li>
            <p>Filter By Price</p>
            <li>
